...
function Precache( context )
	...
	print("[KILLER] Performing pre-load precache")
	...
	PrecacheResource("soundfile", "soundevents/spook_sounds.vsndevts", context)
	...
	PrecacheUnitByNameSync("killer", context)
end
...
LOG_FILE = "log/killer.txt"

InitLogFile(LOG_FILE, "[[ killer ]]")
...
function Activate()
	GameRules.killer = killer()
	GameRules.killer:Initkiller()
end